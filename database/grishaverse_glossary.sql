...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 08. Aug 2021 um 16:49
...
INSERT INTO `personen` (`ID`, `vorname`, `nachname`, `weitere_namen`, `geschlecht`, `nation`, `gruppe`, `grisha_typ`, `beschreibung`, `namegesamt`) VALUES
(1, 'Adrik', 'Zhabin', NULL, 'm', 3, 5, 3, 'Grisha in der Ausbildung, Nadias jüngerer Bruder', 'Adrik Zhabin'),
(2, 'Alexander', 'Lantsov', 'Alexander III. ', 'm', 3, 10, 11, 'Zar von Ravka', 'Alexander Lantsov'),
(3, 'Alina', 'Starkov', 'Sankta Alina, Sol Koroleva (Sonnenkönigin)', 'w', 3, 5, 9, 'Kartografin in der Ersten Armee von Ravka, einzigartige Grisha mit verborgenen Fähigkeiten', 'Alina Starkov'),
(4, 'Alys', 'Van Eck', NULL, 'w', 1, 8, 11, 'Jan Van Ecks zweite Frau', 'Alys Van Eck'),
(5, 'Ana', 'Kuya', NULL, 'w', 3, 9, 11, 'Haushälterin im Waisenhaus von Keramzin', 'Ana Kuya'),
(6, 'Anika', NULL, NULL, 'w', 1, 3, 11, NULL, NULL),
(7, 'Asket', NULL, NULL, 'm', 3, 7, 11, 'Priester, erst Berater im Dienst des Zaren, dann des Dunklen, später Anführer der Soldat Sol', NULL),
(8, 'Baghra', 'Morozova', NULL, 'w', 3, 5, 8, 'mächtige Grisha mit einzigartigen Fähigkeiten, Alinas Lehrerin, Mutter des Dunklen, Tochter von Ilya Morozova', 'Baghra Morozova'),
(9, 'Bastian', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(10, 'Bolliger', NULL, 'Big Bolliger', 'm', 1, 3, 11, NULL, NULL),
(11, 'Botkin', 'Yul-Erdene', NULL, 'm', 5, 9, 11, 'ehemaliger Shu-Han-Söldner, Kampftrainer der Grisha', 'Botkin Yul-Erdene'),
(12, 'Bo', 'Yul-Bayur', NULL, 'm', 5, 5, 7, 'Erfinder des Jurda-Parems, Kuwei Yul-Bos Vater', 'Bo Yul-Bayur'),
(13, 'Colm', 'Fahey', NULL, 'm', 6, 9, 11, 'Jesper Faheys Vater', 'Colm Fahey'),
(14, 'Cornelis', 'Smeet', NULL, 'm', 1, 8, 11, 'Jan Van Ecks Anwalt und Verwalter seines Eigentums', 'Cornelis Smeet'),
(15, 'Danil', 'Markov', NULL, 'm', 3, 5, 5, 'Identur in Ketterdam', 'Danil Markov'),
(16, 'David', 'Kostyk', NULL, 'm', 3, 5, 6, 'Genyas Freund, später Mitglied der Triarchie von Ravka (Vertreter der Fabrikatoren)', 'David Kostyk'),
(17, 'Alexander', 'Morozova', 'Der Dunkle, Der Dunkle Ketzer', 'm', 3, 5, 8, 'mächtiger Grisha mit einzigartigen Fähigkeiten, Anführer der Grisha, Baghras Sohn', 'Alexander Morozova'),
(18, 'Doughty', NULL, NULL, 'm', 1, 2, 11, NULL, NULL),
(19, 'Dunyasha', 'Lazareva', 'Weiße Klinge', 'w', 3, 9, 11, 'Söldnerin und Auftragsmörderin', 'Dunyasha Lazareva'),
(20, 'Eamon', NULL, NULL, 'm', 1, 2, 11, 'Leutnant der Dime-Lions', NULL),
(21, 'Elzinger', NULL, NULL, 'm', 1, 1, 11, NULL, NULL),
(22, 'Emil ', 'Retwenko', NULL, 'm', 3, 5, 3, 'Indentur in Ketterdam', 'Emil  Retwenko'),
(23, 'Eroll', 'Aerts', NULL, 'm', 1, 2, 11, NULL, 'Eroll Aerts'),
(24, 'Fedyor', 'Kaminski', NULL, 'm', 3, 5, 1, NULL, 'Fedyor Kaminski'),
(25, 'Filip', NULL, NULL, 'm', 1, 2, 11, NULL, NULL),
(26, 'Geels', NULL, NULL, 'm', 1, 1, 11, 'Leutnant der Black Tips', NULL),
(27, 'Genya', 'Safin', 'Razrusha\'ya (die Verheerte)', 'w', 3, 5, 10, 'mächtige Grisha mit einzigartigen Fähigkeiten, zuerst im Dienst der Zarin, dann des Dunklen, schließlich Mitglied der Triarchie von Ravka (Vertreterin der Korporalki)', 'Genya Safin'),
(28, 'Gerrigan', NULL, NULL, 'm', 1, 2, 11, NULL, NULL),
(29, 'Gorka', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(30, 'Harshaw', NULL, NULL, 'm', 6, 5, 5, NULL, NULL),
(31, 'Heleen', 'Van Houden', 'Pfau, Tante Heleen', 'w', 1, 9, 11, 'Leiterin der Menagerie \'Haus der Exoten\' in Ketterdam', 'Heleen Van Houden'),
(32, 'Hoede', NULL, NULL, 'm', 1, 8, 11, 'Ratsherr in Ketterdam', NULL),
(33, 'Ilya', 'Morozova', 'Sankt Ilya', 'm', 3, 5, 6, 'mächtiger Grisha, Erschaffer der Kräftemehrer, Vater von Baghra', 'Ilya Morozova'),
(34, 'Inej', 'Ghafa', 'Phantom', 'w', 4, 6, 11, 'Akrobatin, Spionin und Messerkämpferin, ehemals Identur in der Menagerie', 'Inej Ghafa'),
(35, 'Jan', 'Van Eck', NULL, 'm', 1, 8, 11, 'Auftraggeber und Widersacher der Krähen, Wylan Van Ecks Vater', 'Jan Van Eck'),
(36, 'Jarl', 'Brum', NULL, 'm', 7, 4, 11, 'Kommandant der Drüskelle', 'Jarl Brum'),
(37, 'Jesper', 'Fahey', NULL, 'm', 2, 6, 6, 'Scharfschütze, Wylan Van Ecks Freund', 'Jesper Fahey'),
(38, 'Kaz', 'Brekker', 'Dirtyhands, Bastard of the Barrel, Demjin (Dämon) ', 'm', 1, 6, 11, 'Meisterdieb und Schlösserknacker, Leutnant der Dregs, Anführer der Krähen, Haphephobiker', 'Kaz Brekker'),
(40, 'Kuwei', 'Yul-Bo', NULL, 'm', 5, 5, 5, 'Shu-Abtrünniger und Gejagter, Sohn von Bo Yul-Bayur', 'Kuwei Yul-Bo'),
(41, 'Malyen', 'Oretsev', 'Otkazat\'sya (Verlassener)', 'm', 3, 11, 11, 'Fährtenleser in der Ersten Armee von Ravka, Alinas Freund', 'Malyen Oretsev'),
(42, 'Marie', NULL, NULL, 'w', 3, 5, 5, '', NULL),
(43, 'Marya', 'Hendriks', NULL, 'w', 1, 9, 11, 'Wylan Van Ecks Mutter, Jan Van Ecks erste Frau', 'Marya Hendriks'),
(44, 'Matthias', 'Helvar', NULL, 'm', 7, 6, 11, 'in Ungnade gefallener Drüskelle, Nina Zeniks Freund', 'Matthias Helvar'),
(45, 'Misha', NULL, NULL, 'm', 3, 9, 11, 'Baghras Diener, Waise', NULL),
(46, 'Muzzen', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(47, 'Nadia', 'Zhabin', NULL, 'w', 3, 5, 3, 'Adriks Schwester, Tamars Freundin', 'Nadia Zhabin'),
(48, 'Nikolai', 'Lantsov', 'Sturmhond, Sobachka (Welpe), Fuchs', 'm', 3, 10, 11, 'zweiter Sohn Alexanders III., Freibeuter, später Zar von Ravka', 'Nikolai Lantsov'),
(49, 'Nina', 'Zenik', 'Corpsewitch, Drüsje (Hexe)', 'w', 3, 6, 1, 'mächtige Grisha, Überlebende des Jurda-Parems, ehemals Identur in der Weißen Rose, Matthias Helvars Freundin', 'Nina Zenik'),
(50, 'Paja', NULL, NULL, 'w', 4, 5, 7, NULL, NULL),
(51, 'Pekka', 'Rollins', NULL, 'm', 1, 2, 11, 'General der Dime-Lions, Kaz Brekkers Erzfeind', 'Pekka Rollins'),
(52, 'Per', 'Haskell', NULL, 'm', 1, 3, 11, 'General der Dregs', 'Per Haskell'),
(53, 'Pim', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(54, 'Raske', NULL, NULL, 'm', 1, 3, 11, 'freier Demo-Experte ', NULL),
(55, 'Roeder', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(56, 'Rotty', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(57, 'Ruby', NULL, NULL, 'w', 3, 7, 11, NULL, NULL),
(58, 'Seeger', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(59, 'Sergei', 'Beznikov', NULL, 'm', 3, 5, 1, NULL, 'Sergei Beznikov'),
(60, 'Shay', NULL, NULL, 'w', 1, 2, 11, NULL, NULL),
(61, 'Specht', NULL, NULL, 'm', 1, 3, 11, 'ehemaliger Marineoffizier, Dokumentenfälscher ', NULL),
(62, 'Stigg', NULL, NULL, 'm', 7, 5, 5, NULL, NULL),
(63, 'Swann', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(64, 'Tamar', 'Kir-Baatar', NULL, 'w', 5, 5, 1, 'Zwillingsschwester von Tolya, Freundin von Nadia, später Hauptfrau von Zar Nikolais persönlicher Wache', 'Tamar Kir-Baatar'),
(65, 'Tolya', 'Yul-Baatar', NULL, 'm', 5, 5, 1, 'Zwillingsbruder von Tamar', 'Tolya Yul-Baatar'),
(66, 'Varian', NULL, NULL, 'm', 1, 3, 11, NULL, NULL),
(67, 'Vasily', 'Lantsov', 'Tsarevich', 'm', 3, 10, 11, 'erster Sohn Alexander III., Thronfolger', 'Vasily Lantsov'),
(68, 'Vladim', NULL, NULL, 'm', 3, 7, 11, NULL, NULL),
(69, 'Wylan', 'Van Eck', NULL, 'm', 1, 6, 11, 'Demo-Experte, Flötist, Legastheniker, Jan Van Ecks verstoßener Sohn, Jesper Faheys Freund', 'Wylan Van Eck'),
(70, 'Zoya', 'Nazyalenski', 'Sturmhexe', 'w', 3, 5, 3, 'mächtige Grisha, später Mitglied der Triarchie von Ravka (Vertreterin der Ätheralki) ', 'Zoya Nazyalenski');
